            ...
            modelBuilder.Entity("Coboss.Core.Entities.BusinnessTask", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        ...
                        .HasDefaultValue(new DateTime(2024, 1, 2, 21, 38, 44, 281, DateTimeKind.Utc).AddTicks(3552));
                    ...
                    b.Property<DateTime>("Term")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2024, 1, 2, 21, 38, 44, 281, DateTimeKind.Utc).AddTicks(3736));
            ...
            modelBuilder.Entity("Coboss.Core.Entities.BusinnessTaskComment", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2024, 1, 2, 21, 38, 44, 281, DateTimeKind.Utc).AddTicks(2194));
            ...
            modelBuilder.Entity("Coboss.Core.Entities.BusinnessTaskRealisation", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2024, 1, 2, 21, 38, 44, 281, DateTimeKind.Utc).AddTicks(6508));
            ...
            modelBuilder.Entity("Coboss.Core.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTime>("Term")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2024, 1, 2, 21, 38, 44, 282, DateTimeKind.Utc).AddTicks(3516));
            ...
            modelBuilder.Entity("Coboss.Core.Entities.RefreshTokenData", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2024, 1, 2, 21, 38, 44, 282, DateTimeKind.Utc).AddTicks(5370));
